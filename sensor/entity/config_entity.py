...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        try:
            ...
            logging.info(f"Data Ingestion configuration created with collection name: {self.collection_name}")
        except Exception as e:
            raise CustomException(e, sys)
...
class ModelPusherConfig:
    ...
    def __init__(self, training_pipleine_config: TrainingPipelineConfig):
        self.model_evaluation_dir: str = os.path.join(training_pipleine_config.artifact_dir, training_pipeline.MODEL_PUSHER_DIR_NAME)
